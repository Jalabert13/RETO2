...
CREATE DATABASE Ajedrez_B;
USE Ajedrez_B;


CREATE TABLE `cuadro_premios` (
  `tipo_premio` enum('GENERAL','C.VALENCIANA','SUB1800','SUB1600','SUB1400', 'HOSPEDAJE') NOT NULL,
...
CREATE TABLE `Premio` (
  `tipo` enum('GENERAL','C.VALENCIANA','SUB1800','SUB1600','SUB1400', 'HOSPEDAJE') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
