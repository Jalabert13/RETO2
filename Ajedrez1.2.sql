...
-- Tiempo de generación: 09-05-2023 a las 20:45:31
-- Versión del servidor: 10.1.48-MariaDB-0ubuntu0.18.04.1
-- Versión de PHP: 7.2.24-0ubuntu0.18.04.16
...
CREATE TABLE `premios` (
  ...
  `idfide` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `premios`
  ADD CONSTRAINT `fk_premio_fide` FOREIGN KEY (`idfide`) REFERENCES `gen_clasifica` (`idfide`) ON DELETE SET NULL ON UPDATE CASCADE,
